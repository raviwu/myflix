...
feature "User registering", {js: true, vcr: true} do
  ...
  given(:invalid_card) {{ number: '4242424242424241', cvc: '999', exp_month: "12 - December", exp_year: "2025"}}
  given(:declined_card) {{ number: '4000000000000002', cvc: '999', exp_month: "12 - December", exp_year: "2025"}}
